        ...
        try {
            ...
            while (!endFound) {
                ...
                for (let i = 0; i < dataPoints.length - 1; i++) {
                    tmpEthRate.push(
                        dataPoints[i].ethRedeemablePerDeth / 10 ** 18
                    );
                    tmpDethRate.push(
                        dataPoints[i].dethRedeemablePerEth / 10 ** 18
                    );
            ...
            for (var i = 0; i < priceData.data.length - 1; i++) {
                ...
                tmpStringDates.push(
                    timeConverter(parseInt(priceData.data[i]["date"]))
                );
            }
                ...
                for (var i = startValue; i < tmpTimeStamps.length - 1; i++) {
                    if (
                        parseInt(tmpTimeStamps[i]) >=
                            parseInt(priceData.data[k]["date"]) &&
                        parseInt(tmpTimeStamps[i]) <=
            ...
            let endEthPosition =
                finalRedemptionValue / (finalEthValue / buyAmount);
    ...
    return (
        <div>
            <BodyDiv>
                ...
                ></StyledInput>
                <span className="hide-xs">and</span> <strong>withdrew</strong>{" "}
                on
                <StyledInput
                    className="input"
                    type="date"
                ...
                >
                    <div>
                        ...
                        >
                            <Col
                                size={"0 0 auto"}
                                className="margin-bottom-1 margin-right-2"
                            >
                            ...
                            >
                                ...
                                <span
                                    className={
                                        percentageDollarGrowthNoDeth.toFixed(
                                            2
                                        ) >= 0
                                            ? "positive"
                                            : "negative"
                                ...
                                >
                                    ...
                                    {percentageDollarGrowthNoDeth.toFixed(2)}%
                                    Growth)
                                </span>
                            </Col>
                        </EarningsRow>
